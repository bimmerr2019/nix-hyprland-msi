...
<img align="center" width="80%" src="https://github.com/bimmerr2019/nix-hyprland-msi/-/raw/main/config/demo.png" />    
...
- We are using the latest and greatest audio solution for Linux: Pipewire. Not to mention you will have media and volume controls in the notification center available in the top bar.
...
sh <(curl -L https://github.com/bimmerr2019/nix-hyprland-msi/raw/main/install-zaneyos.sh)
```
...
```
git clone https://github.com/bimmerr2019/nix-hyprland-msi.git $HOME/zaneyos
cd zaneyos
```
